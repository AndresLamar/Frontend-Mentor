...
function createCard({title, timeframes}){
    ...
    cardContainer.innerHTML = `
        <div class="activity__card-item-details">
            ...
            <p class="activity__card-item-current-time">${timeframes.weekly.current}hrs</p>
            <p class="activity__card-item-previous-time">Last Week - ${timeframes.weekly.previous}hrs</p>
            </div>
        </div>`
